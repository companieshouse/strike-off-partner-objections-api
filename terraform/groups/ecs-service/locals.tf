...
locals {
  ...
  lb_listener_paths          = ["/strike-off-partner-objections-api/*"]         # paths to route to the service, must be unique across services using the same load balancer listener
