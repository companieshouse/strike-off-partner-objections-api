...
| <a name="input_strike_off_partner_objections_api_version"></a> [strike\_off\_partner\_objections\_api\_version](#input\_strike\_off\_partner\_objections\_api\_version) | The version of the strike\_off\_partner\_objections\_api container to run. | `string` | n/a | yes |
